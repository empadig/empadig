...
# Run empadig without inferred load balancers
...
# Make impact data (with load balancers heuristic)
...
# Make impact data (without load balancers heuristic)
